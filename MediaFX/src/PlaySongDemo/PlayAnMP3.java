...
public class PlayAnMP3 extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		// ----------------------------------------------------------------------
		// Hello!! My name is Maya and I really hope I'm doing this right
		// I'm going to change the song to SwingCheese.mp3 cause I like cheese
		// ----------------------------------------------------------------------
	...
	private class Waiter implements Runnable {
		@Override
		public void run() {
			// Hi! me again...please give me an A lol thanks
			songsPlayed++;
